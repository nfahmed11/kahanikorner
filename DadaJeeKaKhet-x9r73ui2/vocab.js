export const riddles = [
  ...
  },
  {
    ...
    riddles: {
      easy: {
        romanUrdu:
          "Meri gardan lambi hai aur main honk karti hoon. Main kaun hoon?",
        urdu: "میری گردن لمبی ہے اور میں ہونک کرتی ہوں۔ میں کون ہوں؟",
        english: "I have a long neck and say honk. Who am I?",
      },
      medium: {
        romanUrdu:
  ...
  },
  {
    ...
    riddles: {
      ...
      hard: {
        romanUrdu:
          "Main bara janwar hoon, log mujh se qurbani bhi karte hain, main kheton mein bhi kaam aati hoon, aur main moo karti hoon. Main kaun hoon?",
